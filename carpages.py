...
while True:
    ...
    for post in postings:
        try:
            ...
            df = df.append({'Links': link_full, 'Title': title, 'Details': details, 'Price': price, 'Rating': rating},
                           ignore_index=True)
...
df.to_csv('~/PycharmProjects/Web-Scraping/Scraped-Data/airbnb_scraped_data.csv')
